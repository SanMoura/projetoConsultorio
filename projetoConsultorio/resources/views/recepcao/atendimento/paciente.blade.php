                        ...
                        <form method="post" action="{{ route('pacientes.store') }}" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-9 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nm_paciente" placeholder="" value=""
                                        required>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <button class="btn btn-default btn-lg btn-block" type="submit">Continuar para o Atendimento</button>
                                </div>
                            </div>
